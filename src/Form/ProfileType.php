...
class ProfileType extends AbstractType
{
    ...
    {
        $builder
            ->add('facebookUrl', TextType::class, ["attr" => ["placeholder" => "Facebook Url"], "required" => false])
            ->add('twitterUrl', TextType::class, ["attr" => ["placeholder" => "Twitter Url"], "required" => false])
            ->add('instagramUrl', TextType::class, ["attr" => ["placeholder" => "Instagram Url"], "required" => false])
